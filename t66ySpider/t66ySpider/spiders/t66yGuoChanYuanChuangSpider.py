...
from t66ySpider.items import T66YspiderGuochanyuanchuangItem


class t66yGuochanyuanchuangSpider(scrapy.Spider):
    name = 'GuoChanYuanChuang'
    allowed_domains = ['t66y.com']
    start_urls = ["http://t66y.com/thread0806.php?fid=25"]
