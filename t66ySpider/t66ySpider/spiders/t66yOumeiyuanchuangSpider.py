...
from t66ySpider.items import T66YspiderOumeiyuanchuangItem


class t66yOumeiyuanchuangSpider(scrapy.Spider):
    name = 'OuMeiYuanChuang'
    allowed_domains = ['t66y.com']
    start_urls = ["http://t66y.com/thread0806.php?fid=4"]
    ...
    def parse_thread(self, response):
        item = T66YspiderOumeiyuanchuangItem()
