...
from t66ySpider.items import T66YspiderZhongziyuanchuangItem


class t66yZhongziyuanchuangSpider(scrapy.Spider):
    name = 'ZhongZiYuanChuang'
    allowed_domains = ['t66y.com']
    start_urls = ["http://t66y.com/thread0806.php?fid=26"]
    ...
    def parse_thread(self, response):
        item = T66YspiderZhongziyuanchuangItem()
