...
from t66ySpider.items import T66YspiderZhuantiejiaoliuItem


class t66yZhuantiejiaoliuSpider(scrapy.Spider):
    name = 'ZhuanTieJiaoLiu'
    allowed_domains = ['t66y.com']
    start_urls = ["http://t66y.com/thread0806.php?fid=27"]
    ...
    def parse_thread(self, response):
        item = T66YspiderZhuantiejiaoliuItem()
